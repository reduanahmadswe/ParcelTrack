        ...
        <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-border/30 p-4 sm:p-6 lg:p-7 shadow-2xl">
          ...
          <div className="mb-4 sm:mb-5">
            <button
              ...
              className="w-full h-12 sm:h-14 flex items-center justify-center gap-3 bg-white dark:bg-gray-800 border-2 border-border hover:border-gray-300 dark:hover:border-gray-600 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base text-foreground shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]"
            >
            ...
            <div className="relative my-5 sm:my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white/70 dark:bg-slate-800/70 px-2 text-muted-foreground backdrop-blur-sm">
